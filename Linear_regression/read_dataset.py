...
class DataSet:
    ...
    def getDataSetAsNumPy(self):
        samples_values_arr = self.dataSet.iloc[:, 0:-1] #np.array(self.samples_values, ndmin=2)
        target_feature_arr = self.dataSet.iloc[:, -1:] #np.array(self.target_feature, ndmin=2)
